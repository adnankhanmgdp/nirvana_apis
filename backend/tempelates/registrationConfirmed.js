const registrationConfirmationTemplate = (username) => {
    return `<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="container">
            <a href="https://yourwebsite.com"><img class="logo" src="h.png" alt="Logo"></a>
            <div class="message">Thank You for Registering!</div>
            <div class="body">
                <p>Dear ${username},</p>
                <p>Thank you for registering with us. Your account has been successfully created.</p>
                <p>If you did not register or if you have any questions, please contact our support team immediately.</p>
            </div>
